...
A daily severity model for civilian evacuation during the siege of Mariupol (March–May 2022) — open data, IHL-anchored, published as an interactive briefing tool.
